...
# Методы класса Page ::::::::::::::::::::::::::::::::::::::::::::::::
has_next 
# Возвращает True, если это не последняя страница

has_previous 
# Возвращает True, если это не первая страница

has_other_pages 
# Возвращает True, если это не единственная страница

next_page_number 
# Возвращает номер следующей страницы. Если это последняя страница, 
# генерируется исключение InvalidPage

previous_page_number 
# Возвращает номер предыдущей страницы. Если это первая страница, 
# генерируется исключение InvalidPage

start_index 
# Возвращает индекс первой позиции списка из присутствующих 
# на странице

end_index 
# Возвращает индекс последней позиции списка из присутствующих 
# на странице
